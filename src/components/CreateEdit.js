    ...
    return <>
        ...
        <Container className="themed-container" style={{ "width": "70%" }}>
            <Form method="POST">
                ...
                <FormGroup row className="py-3">
                    <TextField required color="warning" id="lname" label="Last name" type="text" variant="filled" name="lname" value={form_data.lname} onChange={handlevent} />
                </FormGroup>
                <FormGroup row className="py-3">
                    <TextField required color="warning" id="email_id" label="Email_id" type="email" variant="filled" name="email" value={form_data.email_id} onChange={handlevent} />
                </FormGroup>
                <FormGroup row>
